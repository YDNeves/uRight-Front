          ...
          <div className="flex flex-col gap-6">
            <div>
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-foreground leading-tight">
                Seu parceiro para <span className="text-primary">crescimento</span>
              </h1>
              <p className="mt-6 text-lg text-foreground/70 leading-relaxed">
                Gerencie sua associação com facilidade. Controle membros, finanças, eventos e comunicações em uma única
            ...
            <div className="grid grid-cols-3 gap-4 pt-8 border-t border-border">
              <div>
                ...
                <p className="text-sm text-foreground/60">Associações</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-primary">10K+</p>
                <p className="text-sm text-foreground/60">Membros Ativos</p>
              </div>
              <div>
